...
_Generated: 2026-09-07T05:33:11.364Z_
...
Workspace `mcp.json` _(folder: digital-tutor-directory)_

- **d:\xampp\htdocs\digital-tutor-directory\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\SAITH GULFAM\.claude.json** — _File exists — no servers defined_
