  ...
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-lg-4">
        ...
        <p class="small text-secondary mb-1"><i class="bi bi-envelope me-2 text-primary"></i>support@digitaltutor.com</p>
        <p class="small text-secondary mb-1"><i class="bi bi-telephone me-2 text-primary"></i>+92 300 1234567</p>
        <p class="small text-secondary"><i class="bi bi-geo-alt me-2 text-primary"></i>Lahore, Pakistan</p>
      </div>
    </div>
