    ...
    <div class="row g-4">
      <div class="col-lg-8">
        <div class="table-card p-4 mb-4">
          <div class="d-flex align-items-center gap-3 mb-4">
            <div class="kpi-card__icon kpi-card__icon--success" style="width:56px;height:56px;font-size:1.5rem">
      ...
      <div class="col-lg-4">
        ...
        <div class="table-card p-4 mt-4">
          <h3 class="h6 fw-bold mb-2">Need to update documents?</h3>
          <p class="small text-muted">Contact support if your qualification or CNIC has changed.</p>
          <button type="button" class="btn btn-outline-primary btn-sm w-100" data-demo>Contact Support</button>
        </div>
      </div>
    </div>
  </main>
